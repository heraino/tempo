...
// This is a server component — it can call server-side functions directly.
// The forms below use "use server" actions so the sign-in logic runs on the server,
// never in the browser. No client-side JavaScript needed.
    ...
    <main className="flex min-h-screen items-center justify-center bg-white px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-500">Sign in to start your training plan.</p>
        </div>

        <div className="flex flex-col gap-4">
          {/* Google OAuth — one tap, no password */}
          <form
            action={async () => {
              "use server"
          ...
          {/* Magic link — enter email, get a sign-in link in your inbox */}
          <form
